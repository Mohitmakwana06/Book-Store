 ...
 * @author Mohit
 */
public class AnsiC extends javax.swing.JFrame{

    /**
     * Creates new form AnsiC
     */
    public AnsiC() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/bookstore/ansi c.png"))); // NOI18N

        book.setFont(new java.awt.Font("Algerian", 0, 36)); // NOI18N
        book.setText("Programming in Ansi C");

        jLabel5.setFont(new java.awt.Font("Georgia", 1, 14)); // NOI18N
        jLabel5.setText("By E.Balagurusamy");

        jLabel6.setText("Learn how to program in C from the master of C, E.Balagurusamy. ");
...
Home h=new Home();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AnsiC.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
